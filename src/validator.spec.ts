...
describe('fonk-negative-number-validator specs', () => {
  ...
  it('should return succeeded validation when it feeds value is negative number', () => {
    // Arrange
    const value = -1;
  ...
  it('should return failed validation when it feeds value is equal to zero, with allowZero flag by default', () => {
    // Arrange
    const value = 0;
  ...
  it('should return failed validation when it feeds value is positive number', () => {
    // Arrange
    const value = 1;
